 ...
 * 
 * 참고 블로그 : https://velog.io/@jh5253/%EB%B0%B1%EC%A4%80-21609-%EC%83%81%EC%96%B4-%EC%A4%91%ED%95%99%EA%B5%90Java%EC%9E%90%EB%B0%94
 *
 * 풀이
 * 1. 가장 크기가 큰 블록 그룹의 기준 블록을 찾는다.
 * 2. 해당 기준 블록의 그룹을 모두 제거해준다.
 * 3. 중력 -> 반시계 90도 회전 -> 중력 적용한다.
 * 4. 위 과정을 반복한다.
 */
public class BOJ_21609_상어중학교_김성수 {
    // 검정 블록, 무지개 블록, 빈 칸
